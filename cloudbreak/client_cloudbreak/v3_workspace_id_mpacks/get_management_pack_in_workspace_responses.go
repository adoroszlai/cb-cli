...
func (o *GetManagementPackInWorkspaceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetManagementPackInWorkspaceOK()
...
func NewGetManagementPackInWorkspaceOK() *GetManagementPackInWorkspaceOK {
	return &GetManagementPackInWorkspaceOK{}
}
...
func (o *GetManagementPackInWorkspaceOK) Error() string {
	return fmt.Sprintf("[GET /v3/{workspaceId}/mpacks/{name}][%d] getManagementPackInWorkspaceOK  %+v", 200, o.Payload)
}

func (o *GetManagementPackInWorkspaceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
