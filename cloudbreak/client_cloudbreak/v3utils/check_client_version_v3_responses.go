...
func (o *CheckClientVersionV3Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCheckClientVersionV3OK()
...
func (o *CheckClientVersionV3OK) Error() string {
	return fmt.Sprintf("[GET /v3/utils/client/{version}][%d] checkClientVersionV3OK  %+v", 200, o.Payload)
}

func (o *CheckClientVersionV3OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models_cloudbreak.VersionCheckResult)
