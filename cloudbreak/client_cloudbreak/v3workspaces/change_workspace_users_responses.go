...
func (o *ChangeWorkspaceUsersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewChangeWorkspaceUsersOK()
...
func (o *ChangeWorkspaceUsersOK) Error() string {
	return fmt.Sprintf("[PUT /v3/workspaces/name/{name}][%d] changeWorkspaceUsersOK  %+v", 200, o.Payload)
}

func (o *ChangeWorkspaceUsersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
