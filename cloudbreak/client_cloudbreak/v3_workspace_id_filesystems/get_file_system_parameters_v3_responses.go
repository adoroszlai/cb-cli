...
func (o *GetFileSystemParametersV3Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetFileSystemParametersV3OK()
...
func NewGetFileSystemParametersV3OK() *GetFileSystemParametersV3OK {
	return &GetFileSystemParametersV3OK{}
}
...
func (o *GetFileSystemParametersV3OK) Error() string {
	return fmt.Sprintf("[POST /v3/{workspaceId}/filesystems/parameters][%d] getFileSystemParametersV3OK  %+v", 200, o.Payload)
}

func (o *GetFileSystemParametersV3OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models_cloudbreak.StructuredParameterQueriesResponse)
