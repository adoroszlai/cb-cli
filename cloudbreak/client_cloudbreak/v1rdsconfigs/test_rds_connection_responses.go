...
func (o *TestRdsConnectionOK) Error() string {
	return fmt.Sprintf("[POST /v1/rdsconfigs/testconnect][%d] testRdsConnectionOK  %+v", 200, o.Payload)
}

func (o *TestRdsConnectionOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
