...
func (o *PostPublicManagementPackParams) WithBody(body *models_cloudbreak.ManagementPackRequest) *PostPublicManagementPackParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post public management pack params
func (o *PostPublicManagementPackParams) SetBody(body *models_cloudbreak.ManagementPackRequest) {
	o.Body = body
}
