...
func (o *PostPrivateBlueprintOK) Error() string {
	return fmt.Sprintf("[POST /v1/blueprints/user][%d] postPrivateBlueprintOK  %+v", 200, o.Payload)
}

func (o *PostPrivateBlueprintOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
