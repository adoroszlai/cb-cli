...
import (
	...
	cb "github.com/hortonworks/cb-cli/cloudbreak/v2"
	_ "github.com/hortonworks/cb-cli/cloudbreak/v2/cloud/aws"
	_ "github.com/hortonworks/cb-cli/cloudbreak/v2/cloud/azure"
	_ "github.com/hortonworks/cb-cli/cloudbreak/v2/cloud/gcp"
	_ "github.com/hortonworks/cb-cli/cloudbreak/v2/cloud/openstack"
	_ "github.com/hortonworks/cb-cli/cloudbreak/v2/cloud/yarn"
							...
							Subcommands: []cli.Command{
								{
									...
									Before: ConfigRead,
									Flags:  cb.NewFlagBuilder().AddFlags(cb.FlBlueprintNameOptional, cb.FlBlueprintFileOptional, cb.FlCloudStorageTypeOptional, cb.FlDefaultEncryptionOptional, cb.FlCustomEncryptionOptional).AddAuthenticationFlags().AddTemplateFlags().Build(),
									Action: cb.GenerateAwsStackTemplate,
									BashComplete: func(c *cli.Context) {
										for _, f := range cb.NewFlagBuilder().AddFlags(cb.FlBlueprintNameOptional, cb.FlBlueprintFileOptional, cb.FlCloudStorageTypeOptional, cb.FlDefaultEncryptionOptional, cb.FlCustomEncryptionOptional).AddAuthenticationFlags().AddTemplateFlags().Build() {
											printFlagCompletion(f)
										}
									},
								},
							...
							Subcommands: []cli.Command{
								{
									...
									Before: ConfigRead,
									Flags:  cb.NewFlagBuilder().AddFlags(cb.FlBlueprintNameOptional, cb.FlBlueprintFileOptional, cb.FlCloudStorageTypeOptional, cb.FlRawEncryptionOptional, cb.FlRsaEncryptionOptional, cb.FlKmsEncryptionOptional).AddAuthenticationFlags().AddTemplateFlags().Build(),
									Action: cb.GenerateGcpStackTemplate,
									BashComplete: func(c *cli.Context) {
										for _, f := range cb.NewFlagBuilder().AddFlags(cb.FlBlueprintNameOptional, cb.FlBlueprintFileOptional, cb.FlCloudStorageTypeOptional, cb.FlRawEncryptionOptional, cb.FlRsaEncryptionOptional, cb.FlKmsEncryptionOptional).AddAuthenticationFlags().AddTemplateFlags().Build() {
											printFlagCompletion(f)
										}
									},
								},
		...
		},
		{
			...
			Subcommands: []cli.Command{
				...
				},
				{
					...
					Flags:  cb.NewFlagBuilder().AddFlags(cb.FlName).AddOutputFlag().AddAuthenticationFlags().Build(),
					Before: ConfigRead,
					Action: cb.DescribeImagecatalog,
					BashComplete: func(c *cli.Context) {
						for _, f := range cb.NewFlagBuilder().AddFlags(cb.FlName).AddOutputFlag().AddAuthenticationFlags().Build() {
							printFlagCompletion(f)
						}
