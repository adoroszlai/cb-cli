...
func (o *PostPublicProxyConfigParams) WithBody(body *models_cloudbreak.ProxyConfigRequest) *PostPublicProxyConfigParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post public proxy config params
func (o *PostPublicProxyConfigParams) SetBody(body *models_cloudbreak.ProxyConfigRequest) {
	o.Body = body
}
