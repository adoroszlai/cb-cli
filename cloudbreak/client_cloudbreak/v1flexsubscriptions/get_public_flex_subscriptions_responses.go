...
func (o *GetPublicFlexSubscriptionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetPublicFlexSubscriptionsOK()
...
func NewGetPublicFlexSubscriptionsOK() *GetPublicFlexSubscriptionsOK {
	return &GetPublicFlexSubscriptionsOK{}
}
...
func (o *GetPublicFlexSubscriptionsOK) Error() string {
	return fmt.Sprintf("[GET /v1/flexsubscriptions/account][%d] getPublicFlexSubscriptionsOK  %+v", 200, o.Payload)
}

func (o *GetPublicFlexSubscriptionsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
