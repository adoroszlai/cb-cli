...
func (o *GetPrivateStackOK) Error() string {
	return fmt.Sprintf("[GET /v1/stacks/user/{name}][%d] getPrivateStackOK  %+v", 200, o.Payload)
}

func (o *GetPrivateStackOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
