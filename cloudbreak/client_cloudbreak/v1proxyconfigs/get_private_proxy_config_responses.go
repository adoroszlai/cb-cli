...
func (o *GetPrivateProxyConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetPrivateProxyConfigOK()
...
func NewGetPrivateProxyConfigOK() *GetPrivateProxyConfigOK {
	return &GetPrivateProxyConfigOK{}
}
...
func (o *GetPrivateProxyConfigOK) Error() string {
	return fmt.Sprintf("[GET /v1/proxyconfigs/user/{name}][%d] getPrivateProxyConfigOK  %+v", 200, o.Payload)
}

func (o *GetPrivateProxyConfigOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
