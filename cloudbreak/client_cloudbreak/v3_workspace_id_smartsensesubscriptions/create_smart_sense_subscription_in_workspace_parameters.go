...
// NewCreateSmartSenseSubscriptionInWorkspaceParams creates a new CreateSmartSenseSubscriptionInWorkspaceParams object
// with the default values initialized.
func NewCreateSmartSenseSubscriptionInWorkspaceParams() *CreateSmartSenseSubscriptionInWorkspaceParams {
	var ()
	return &CreateSmartSenseSubscriptionInWorkspaceParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewCreateSmartSenseSubscriptionInWorkspaceParamsWithTimeout creates a new CreateSmartSenseSubscriptionInWorkspaceParams object
...
// NewCreateSmartSenseSubscriptionInWorkspaceParamsWithContext creates a new CreateSmartSenseSubscriptionInWorkspaceParams object
...
// NewCreateSmartSenseSubscriptionInWorkspaceParamsWithHTTPClient creates a new CreateSmartSenseSubscriptionInWorkspaceParams object
...
/*CreateSmartSenseSubscriptionInWorkspaceParams contains all the parameters to send to the API endpoint
for the create smart sense subscription in workspace operation typically these are written to a http.Request
*/
