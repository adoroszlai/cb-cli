...
func (o *ChangeImageParams) WithBody(body *models_cloudbreak.StackImageChangeRequest) *ChangeImageParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the change image params
func (o *ChangeImageParams) SetBody(body *models_cloudbreak.StackImageChangeRequest) {
	o.Body = body
}
