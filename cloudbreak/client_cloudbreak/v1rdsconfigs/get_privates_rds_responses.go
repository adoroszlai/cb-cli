...
func (o *GetPrivatesRdsOK) Error() string {
	return fmt.Sprintf("[GET /v1/rdsconfigs/user][%d] getPrivatesRdsOK  %+v", 200, o.Payload)
}

func (o *GetPrivatesRdsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
