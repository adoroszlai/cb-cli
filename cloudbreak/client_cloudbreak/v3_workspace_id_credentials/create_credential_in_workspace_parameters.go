...
func (o *CreateCredentialInWorkspaceParams) WithBody(body *models_cloudbreak.CredentialRequest) *CreateCredentialInWorkspaceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create credential in workspace params
func (o *CreateCredentialInWorkspaceParams) SetBody(body *models_cloudbreak.CredentialRequest) {
	o.Body = body
}
