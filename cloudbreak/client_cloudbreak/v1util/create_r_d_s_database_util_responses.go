...
func (o *CreateRDSDatabaseUtilOK) Error() string {
	return fmt.Sprintf("[POST /v1/util/rds-database][%d] createRDSDatabaseUtilOK  %+v", 200, o.Payload)
}

func (o *CreateRDSDatabaseUtilOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
