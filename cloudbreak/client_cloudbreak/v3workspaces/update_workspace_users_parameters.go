...
func (o *UpdateWorkspaceUsersParams) WithBody(body []*models_cloudbreak.ChangeWorkspaceUsersJSON) *UpdateWorkspaceUsersParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update workspace users params
func (o *UpdateWorkspaceUsersParams) SetBody(body []*models_cloudbreak.ChangeWorkspaceUsersJSON) {
	o.Body = body
}
