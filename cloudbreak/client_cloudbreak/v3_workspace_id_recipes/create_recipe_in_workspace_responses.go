...
func (o *CreateRecipeInWorkspaceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCreateRecipeInWorkspaceOK()
...
func (o *CreateRecipeInWorkspaceOK) Error() string {
	return fmt.Sprintf("[POST /v3/{workspaceId}/recipes][%d] createRecipeInWorkspaceOK  %+v", 200, o.Payload)
}

func (o *CreateRecipeInWorkspaceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
