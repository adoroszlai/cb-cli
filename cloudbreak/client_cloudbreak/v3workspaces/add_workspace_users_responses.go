...
func (o *AddWorkspaceUsersOK) Error() string {
	return fmt.Sprintf("[PUT /v3/workspaces/name/{name}/addUsers][%d] addWorkspaceUsersOK  %+v", 200, o.Payload)
}

func (o *AddWorkspaceUsersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
