...
func (o *ListStacksByWorkspaceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListStacksByWorkspaceOK()
...
func NewListStacksByWorkspaceOK() *ListStacksByWorkspaceOK {
	return &ListStacksByWorkspaceOK{}
}
...
func (o *ListStacksByWorkspaceOK) Error() string {
	return fmt.Sprintf("[GET /v3/{workspaceId}/stacks][%d] listStacksByWorkspaceOK  %+v", 200, o.Payload)
}

func (o *ListStacksByWorkspaceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
