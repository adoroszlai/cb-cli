...
func (o *GetUserUsageOK) Error() string {
	return fmt.Sprintf("[GET /v1/usages/user][%d] getUserUsageOK  %+v", 200, o.Payload)
}

func (o *GetUserUsageOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
