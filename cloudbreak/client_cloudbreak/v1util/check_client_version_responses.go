...
func (o *CheckClientVersionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCheckClientVersionOK()
...
func (o *CheckClientVersionOK) Error() string {
	return fmt.Sprintf("[GET /v1/util/client/{version}][%d] checkClientVersionOK  %+v", 200, o.Payload)
}

func (o *CheckClientVersionOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
