...
func (o *GetCloudStorageMatrixV3Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCloudStorageMatrixV3OK()
...
func NewGetCloudStorageMatrixV3OK() *GetCloudStorageMatrixV3OK {
	return &GetCloudStorageMatrixV3OK{}
}
...
func (o *GetCloudStorageMatrixV3OK) Error() string {
	return fmt.Sprintf("[GET /v3/utils/cloudstoragematrix][%d] getCloudStorageMatrixV3OK  %+v", 200, o.Payload)
}

func (o *GetCloudStorageMatrixV3OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
