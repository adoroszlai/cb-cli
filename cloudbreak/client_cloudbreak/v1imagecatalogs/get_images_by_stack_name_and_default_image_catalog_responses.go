...
func (o *GetImagesByStackNameAndDefaultImageCatalogReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetImagesByStackNameAndDefaultImageCatalogOK()
...
func NewGetImagesByStackNameAndDefaultImageCatalogOK() *GetImagesByStackNameAndDefaultImageCatalogOK {
	return &GetImagesByStackNameAndDefaultImageCatalogOK{}
}
...
func (o *GetImagesByStackNameAndDefaultImageCatalogOK) Error() string {
	return fmt.Sprintf("[GET /v1/imagecatalogs/account/upgrade/{stackName}][%d] getImagesByStackNameAndDefaultImageCatalogOK  %+v", 200, o.Payload)
}

func (o *GetImagesByStackNameAndDefaultImageCatalogOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
