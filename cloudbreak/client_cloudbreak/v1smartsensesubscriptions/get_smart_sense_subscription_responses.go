...
func (o *GetSmartSenseSubscriptionOK) Error() string {
	return fmt.Sprintf("[GET /v1/smartsensesubscriptions][%d] getSmartSenseSubscriptionOK  %+v", 200, o.Payload)
}

func (o *GetSmartSenseSubscriptionOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
