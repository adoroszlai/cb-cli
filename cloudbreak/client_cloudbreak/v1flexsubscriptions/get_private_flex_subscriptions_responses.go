...
func (o *GetPrivateFlexSubscriptionsOK) Error() string {
	return fmt.Sprintf("[GET /v1/flexsubscriptions/user][%d] getPrivateFlexSubscriptionsOK  %+v", 200, o.Payload)
}

func (o *GetPrivateFlexSubscriptionsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
